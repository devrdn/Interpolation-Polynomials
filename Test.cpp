...
int main()
{
    ...
    double a = -7.0 / 3; // Левая граница
    double b = 1.0 / 3; // Правая граница
    int n; // количество разбиений
    vector<double> x{ -7.0 / 3, -2.0 / 3,  1.0 / 3, 0.0, -3.0 }; // точки, в которых будет вычислены многочлены

    // Считываем количество разбиений
    cout << "Count of Fragments: ";
    cin >> n;
    double h = (b - a) / n; // приращение на каждом шаге по оси Ox
